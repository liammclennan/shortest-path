...
namespace ShortestPath.Core.Bing.TokenService {
    ...
    public partial class CommonService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public CommonService() {
            this.Url = global::ShortestPath.Core.Properties.Settings.Default.ShortestPath_Core_Bing_TokenService_CommonService;
